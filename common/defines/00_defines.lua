...
NDiplomacy = {
	...
	BASE_CONDITIONAL_PEACE_WARESCORE_RATIO = 0.35, 	-- Warscore ratio needed for the losing side to able to surrender.
	...
	PEACE_SCORE_PER_PASS = 0.4,						-- When you pass in a peace deal you gain this percent of your original score
...
NCountry = {
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_VP = 20,-- War support will be scaled down if there's less VP than this in the province
	...
	WAR_SUPPORT_DEFENSIVE_WAR = 0.5,				-- Impact of being in defensive war
...
NMilitary = {
	...
	NUKEROCKET_MIN_DAMAGE_PERCENT = 0.4,			-- Minimum damage from nukes as a percentage of current strength/organisation
	NUKEROCKET_MAX_DAMAGE_PERCENT = 1,				-- Minimum damage from nukes as a percentage of current strength/organisation
...
NAir = {
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.30,		-- How much air superiority is needed for a tactical bomber to be able to nuke a province
	STRATEGIC_BOMBER_NUKEROCKET_AIR_SUPERIORITY = 0,	-- How much air superiority is needed for a nuclear missile to be able to nuke a province
